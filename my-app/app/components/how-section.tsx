    ...
    <section id="how" className="py-20 px-6 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6">
          ...
          <div className="md:col-span-2 md:row-span-2 group relative overflow-hidden p-8 sm:p-12 border border-zinc-200 rounded-[2.5rem] bg-zinc-900 text-white transition-all duration-300 hover:shadow-2xl">
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                <div className="text-5xl mb-8">📞</div>
                <h4 className="text-2xl sm:text-4xl font-bold mb-4 tracking-tight">Call the GRID Hotline</h4>
          ...
          <div className="group p-8 border border-zinc-200 rounded-[2.5rem] bg-white hover:bg-zinc-50 transition-all duration-300 shadow-sm hover:shadow-md flex flex-col justify-between">
